...
class AdminCallbacks extends BaseController {
	...
	public function merchiProductMountPointClass() {
		$value = esc_attr( get_option( 'merchi_product_mount_point_class' ) );
		echo '<input type="text" class="regular-text" name="merchi_product_mount_point_class" value="' . $value . '" placeholder="example_class">';
	}
