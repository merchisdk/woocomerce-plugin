document.addEventListener('DOMContentLoaded', function(event) {
  ...
  script.src = jQuery('#plugin_merchi_url').val() + `/static/product_embed/js/product.embed.js?product=${productId}&hidePreview=true&hideTitle=true&hideInfo=true&hidePrice=true&includeBootstrap=false&singleColumn=true&notIncludeDefaultCss=true&redirectAfterSuccessUrl=${redirectAfterSuccessUrl}`;
